...
<qgis autoRefreshMode="Disabled" simplifyMaxScale="1" symbologyReferenceScale="-1" maxScale="0" simplifyDrawingHints="1" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" minScale="0" simplifyAlgorithm="0" simplifyLocal="1" readOnly="0" labelsEnabled="1" version="3.40.0-Bratislava" autoRefreshTime="0" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|MapTips|Rendering|CustomProperties|Notes">
  ...
  <renderer-v2 type="singleSymbol" forceraster="0" symbollevels="0" referencescale="-1" enableorderby="0">
    <symbols>
      <symbol force_rhr="0" alpha="1" type="line" name="0" clip_to_extent="1" is_animated="0" frame_rate="10">
        ...
        <layer locked="0" class="SimpleLine" enabled="1" pass="0" id="{d57e4065-d202-464d-928d-6a3459c32297}">
          <Option type="Map">
            ...
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                ...
                <Option type="Map" name="outlineColor">
                  <Option type="bool" name="active" value="true"/>
                  <Option type="QString" name="expression" value="if(IniStatus is NULL, '#85b66f',if(IniStatus is 'CLOSED', '#ff0f13', if(IniStatus !='ACTIVE', '#85b66f','#ff9900')))"/>
                  <Option type="int" name="type" value="3"/>
                </Option>
              </Option>
              <Option type="QString" name="type" value="collection"/>
        ...
        <layer locked="0" class="MarkerLine" enabled="1" pass="0" id="{2168a092-f2c4-4bee-a00f-99e5ceaae9f4}">
          <Option type="Map">
          ...
          <symbol force_rhr="0" alpha="1" type="marker" name="@0@1" clip_to_extent="1" is_animated="0" frame_rate="10">
            ...
            <layer locked="0" class="SvgMarker" enabled="1" pass="0" id="{8822a772-efa6-4354-b7d5-8c51f60ece01}">
              <Option type="Map">
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol force_rhr="0" alpha="1" type="line" name="" clip_to_extent="1" is_animated="0" frame_rate="10">
        ...
        <layer locked="0" class="SimpleLine" enabled="1" pass="0" id="{e4dc2e9a-2e17-4cce-8315-47b58ab43686}">
          <Option type="Map">
            <Option type="QString" name="align_dash_pattern" value="0"/>
            <Option type="QString" name="capstyle" value="square"/>
            <Option type="QString" name="customdash" value="5;2"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style previewBkgrdColor="255,255,255,255,rgb:1,1,1,1" fontWeight="50" isExpression="1" allowHtml="0" multilineHeight="1" fontItalic="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOrientation="horizontal" textOpacity="1" tabStopDistanceUnit="Point" fontSize="8" useSubstitutions="0" legendString="Aa" fontKerning="1" tabStopDistance="80" fontWordSpacing="0" blendMode="0" fieldName="concat(&quot;Type&quot;,' ',&quot;Id&quot;)" forcedBold="0" multilineHeightUnit="Percentage" fontSizeUnit="Point" fontStrikeout="0" textColor="51,160,44,255,rgb:0.20000000000000001,0.62745098039215685,0.17254901960784313,1" fontFamily="Arial" fontLetterSpacing="0" forcedItalic="0" namedStyle="Normal" fontUnderline="0" tabStopDistanceMapUnitScale="3x:0,0,0,0,0,0" capitalization="0">
        <families/>
  ...
  <customproperties>
    <Option type="Map">
      ...
      <Option type="QString" name="qgisred_identifier" value="qgisred_valves"/>
  ...
  <fieldConfiguration>
    ...
    <field name="Setting" configurationFlags="NoFlag"/>
    <field name="IdHeadLoss" configurationFlags="NoFlag"/>
  ...
  <aliases>
    ...
    <alias field="Setting" name="" index="3"/>
    <alias field="IdHeadLoss" name="" index="4"/>
    <alias field="LossCoeff" name="" index="5"/>
    <alias field="IniStatus" name="" index="6"/>
    <alias field="Tag" name="" index="7"/>
    <alias field="Descrip" name="" index="8"/>
  </aliases>
  <splitPolicies>
  ...
  <defaults>
    ...
    <default field="Setting" applyOnUpdate="0" expression=""/>
    <default field="IdHeadLoss" applyOnUpdate="0" expression=""/>
  ...
  <constraints>
    ...
    <constraint constraints="0" field="Setting" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="IdHeadLoss" exp_strength="0" notnull_strength="0" unique_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="Setting" exp="" desc=""/>
    <constraint field="IdHeadLoss" exp="" desc=""/>
