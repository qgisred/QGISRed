...
<qgis version="2.18.26" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="InstDate">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <aliases>
    ...
    <alias field="Material" index="3" name=""/>
    <alias field="InstDate" index="4" name=""/>
    <alias field="Tag" index="5" name=""/>
    <alias field="Descrip" index="6" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <attributeactions default="-1"/>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="1851880020">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="InstDate"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="InstDate" expression=""/>
