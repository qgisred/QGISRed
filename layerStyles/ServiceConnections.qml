...
<qgis maxScale="0" labelsEnabled="0" simplifyAlgorithm="0" autoRefreshTime="0" simplifyMaxScale="1" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|MapTips|Rendering|CustomProperties|Notes" simplifyLocal="1" readOnly="0" simplifyDrawingTol="1" symbologyReferenceScale="-1" autoRefreshMode="Disabled" hasScaleBasedVisibilityFlag="0" version="3.40.0-Bratislava" minScale="0" simplifyDrawingHints="0">
  ...
  <renderer-v2 referencescale="-1" enableorderby="0" type="singleSymbol" forceraster="0" symbollevels="0">
    <symbols>
      <symbol force_rhr="0" frame_rate="10" type="marker" is_animated="0" name="0" alpha="1" clip_to_extent="1">
        ...
        <layer locked="0" id="{bc586c0b-7225-4b07-881a-b4d6285f0889}" pass="0" class="SvgMarker" enabled="1">
          <Option type="Map">
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol force_rhr="0" frame_rate="10" type="marker" is_animated="0" name="" alpha="1" clip_to_extent="1">
        ...
        <layer locked="0" id="{6fbef358-6d16-4f45-9473-486d0082e734}" pass="0" class="SimpleMarker" enabled="1">
          <Option type="Map">
            <Option type="QString" value="0" name="angle"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style tabStopDistanceUnit="Point" textOrientation="horizontal" multilineHeight="1" blendMode="0" fontWordSpacing="0" multilineHeightUnit="Percentage" fontItalic="1" fontStrikeout="0" fontSize="7" fontWeight="50" fontSizeUnit="Point" fontUnderline="0" legendString="Aa" fontKerning="1" previewBkgrdColor="255,255,255,255,rgb:1,1,1,1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontFamily="Arial" fontLetterSpacing="0" forcedItalic="0" namedStyle="Italic" useSubstitutions="0" textColor="51,160,44,255,rgb:0.20000000000000001,0.62745098039215685,0.17254901960784313,1" tabStopDistance="80" forcedBold="0" capitalization="0" fieldName="Id" tabStopDistanceMapUnitScale="3x:0,0,0,0,0,0" isExpression="0" allowHtml="0" textOpacity="1">
        <families/>
  ...
  <customproperties>
    <Option type="Map">
      ...
      <Option type="QString" value="qgisred_isolationvalves" name="qgisred_identifier"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="NoFlag" name="Available"/>
  ...
  <aliases>
    ...
    <alias index="2" field="LossCoeff" name=""/>
    <alias index="3" field="Status" name=""/>
    <alias index="4" field="Available" name=""/>
    <alias index="5" field="InstDate" name=""/>
    <alias index="6" field="Tag" name=""/>
    <alias index="7" field="Descrip" name=""/>
  </aliases>
  <splitPolicies>
    ...
    <policy field="Available" policy="Duplicate"/>
  ...
  <constraints>
    ...
    <constraint field="Available" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="Available"/>
  ...
  <mapTip enabled="1">Isolation Valve [% "Id" %]</mapTip>
