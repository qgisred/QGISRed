...
class QGISRedImportDialog(QDialog, FORM_CLASS):
    ...
    def pipeLayerChanged(self):
        ...
        self.selectComboBoxItem(self.cbPipe_Id, ["pipeid", "id"])
    ...
    def valveLayerChanged(self):
        ...
        self.selectComboBoxItem(self.cbValve_Id, ["valveid", "id"])
        self.selectComboBoxItem(self.cbValve_Diameter, ["diameter", "diam", "diametro", "diámetro"])
        self.selectComboBoxItem(self.cbValve_Type, ["valvetype", "type", "tipo"])
    ...
    def pumpLayerChanged(self):
        ...
        self.selectComboBoxItem(self.cbPump_Id, ["pumpid", "id"])
        self.selectComboBoxItem(self.cbPump_Power, ["power", "potencia"])
        self.selectComboBoxItem(self.cbPump_PumpCurve, ["pumpcurvid", "idhfcurve"])
        self.selectComboBoxItem(self.cbPump_EfficCurve, ["efficurvid", "idefficur"])
    ...
    def tankLayerChanged(self):
        ...
        self.selectComboBoxItem(self.cbTank_Id, ["tankid", "id"])
    ...
    def reservoirLayerChanged(self):
        ...
        self.selectComboBoxItem(self.cbReservoir_Id, ["reservid", "id"])
        self.selectComboBoxItem(self.cbReservoir_TotHead, ["totalhead"])
        self.selectComboBoxItem(self.cbReservoir_HeadPatt, ["headpattid", "idheadpatt"])
    ...
    def junctionLayerChanged(self):
        ...
        self.selectComboBoxItem(self.cbJunction_Id, ["junctionid", "id"])
    ...
    def serviceConnectionLayerChanged(self):
        ...
        self.selectComboBoxItem(self.cbServiceConnection_InstDate, ["instaldate", "instdate", "date", "fecha", "fecha_de_i"])
    ...
    def isolationValveLayerChanged(self):
        ...
        self.selectComboBoxItem(self.cbIsolationValve_Id, ["isovalveid", "id"])
        ...
        self.selectComboBoxItem(self.cbIsolationValve_InstDate, ["instaldate", "instdate", "date", "fecha", "fecha_de_i"])
    ...
    def meterLayerChanged(self):
        ...
        self.selectComboBoxItem(self.cbMeter_Id, ["meterid", "id"])
        self.selectComboBoxItem(self.cbMeter_Type, ["metertype", "type", "tipo", "meter", "medidor"])
        self.selectComboBoxItem(self.cbMeter_Active, ["active", "activo"])
        self.selectComboBoxItem(self.cbMeter_InstDate, ["instaldate", "instdate", "date", "fecha", "fecha_de_i"])
